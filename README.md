...
## Project Structure
    ...
    ├── withfrank_wordpress_30651  # Django project configurations
...
1. Clone this repo and `cd withfrank_wordpress_30651`
...
2. Clone this repo and `cd withfrank_wordpress_30651`
